...
const MONGO_URI  = process.env.MONGO_URI || 'mongodb+srv://anja:anja@cluster0.bwlvpsm.mongodb.net/BestPrice?retryWrites=true&w=majority';
...
async function exists(f) {
  try { await fs.access(f); return true; }
  catch { return false; }
}
